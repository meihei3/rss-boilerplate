...
class App_KernelDevContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'content_source_url' => $container->getEnv('string:default:content_source_default:CONTENT_SOURCE_URL'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'content_source_default' => 'https://api.example.com/changelog',
            'public_directory' => (\dirname(__DIR__, 4).'/docs/'),
